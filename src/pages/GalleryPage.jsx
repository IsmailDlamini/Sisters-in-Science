    ...
    return (
      ...
      <LoadingSpinner />
        ...
        <div className="gallery-page-container">
          ...
          <img src={Atom} className="atom-1-gallery rotating" alt="" />
          <img src={Atom} className="atom-2-gallery rotating" alt="" />
          <img src={Atom} className="atom-3-gallery rotating" alt="" />
          <img src={Atom} className="atom-4-gallery rotating" alt="" />
        </div>
